...
<div class="support-ticket-page {{ $isModal ? 'support-ticket-shell' : '' }}">
        ...
        <section class="support-card is-accent" style="--support-card-color:#10b981;">
            ...
            <form method="post" action="{{ route('club.tickets.reply', $ticket) }}" enctype="multipart/form-data" class="support-form-grid">
                ...
                <div>
                    ...
                    <input id="ticketReplyFile" type="file" name="attachment" data-hint="پیوست پاسخ تیکت؛ تصویر، PDF، Word، Excel، ZIP یا متن؛ حداکثر ۵ مگابایت.">
                    <small class="support-file-note">اگر فایل یا تصویر مرتبط دارید، آن را پیوست کنید.</small>
                </div>
